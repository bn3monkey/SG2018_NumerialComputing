...
#ifdef CPU
	cpu_program = new cloth_cal_cpu(1, 4, NUM_ITER, DELTA_T, NUM_PARTICLES_X, NUM_PARTICLES_Y, CLOTH_SIZE_X, CLOTH_SIZE_Y, PARTICLE_MASS, PARTICLE_INV_MASS, SPRING_K, DAMPING_CONST, GRAVITY);
#endif
	return true;
